...
import kotlinx.android.synthetic.main.fragment_lab_registeration2.*
import java.io.File
import java.util.*


class LabRegisterationFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_lab_registeration2, container, false)
    }
    ...
    fun validateInputData(){
        mContext!!.labRegisterationModel!!.firstName_ar=editee_fn_ar_txt.text.toString().split(" ")[0].toString()
        mContext!!.labRegisterationModel!!.lastName_ar=editee_fn_ar_txt.text.toString().split(" ")[1].toString()
        mContext!!.labRegisterationModel!!.firstName_en=editee_fn_en_txt.text.toString().split(" ")[0].toString()
        mContext!!.labRegisterationModel!!.lastName_en=editee_fn_en_txt.text.toString().split(" ")[1].toString()
        handelImages()
        mContext!!.labRegisterationModel!!.gender_id=gender.toString()
    ...
    private fun handelImages(){
        ...
        mContext!!.labRegisterationModel!!.featured=img
        var img2=""
        ...
        mContext!!.labRegisterationModel!!.practiceLicenseID=img2
        var img3=""
        ...
        mContext!!.labRegisterationModel!!.profissionalTitleID=img3
    }
